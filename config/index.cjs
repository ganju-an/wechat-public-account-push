...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx189a1a86d9c1cc5b',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '1d9e5f7f53e519e5afe2bdae2d952def',
  ...
  TIAN_API: {
    ...
    key: '263f594d012849e98713477451230d53',
  ...
  USERS: [
    {
      ...
      id: 'oBuvz7J7lyEq8diLHzH63ely4CiU',
      ...
      festivals: [
        ...
        {
          type: '节日', name: '认识纪念日', year: '2024', date: '11-01',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2025-02-22' },
        // 结婚纪念日
  ...
  FESTIVALS: [
    ...
    {
      type: '节日', name: '恋爱纪念日', year: '2020', date: '09-03',
    },
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {
      type: '生日', name: '小狐', year: '2005', date: '03-18', isShowAge: true,
      type: '生日', name: '小猫', year: '2002', date: '05-13', isShowAge: true,
    },
    {
      type: '节日', name: '认识纪念日', year: '2024', date: '11-01',
